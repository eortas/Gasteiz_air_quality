  ...
  perfChart = new Chart(ctx, {
      ...
      data: {
          ...
          datasets: [
              ...
              { label: t.forecastD1, data: d1Forecast, borderColor: getCssVar('--green'), backgroundColor: getCssVar('--green'), showLine: false, pointRadius: 7, pointStyle: 'circle' },
              { label: t.forecastD2, data: d2Forecast, borderColor: getCssVar('--yellow'), backgroundColor: getCssVar('--yellow'), borderDash: [3,3], borderWidth: 3, pointRadius: ctx => ctx.dataIndex === historicalLabels.length ? 0 : 8, pointStyle: 'triangle', tension: 0.2 }
          ]
      },
